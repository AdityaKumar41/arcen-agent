# Streaming LLM Response Support for Arcen Agent
...
```
ARCEN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ARCEN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `arcen_cli/config.py` | 1 | +streaming config defaults |
