...
projection into Arcen' display, approval bridging, transcript projection into
...
"codex_app_server"`. Arcen' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("ARCEN_KANBAN_TASK"):
            kanban_db = spawn_env.get("ARCEN_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "ARCEN_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("ARCEN_HOME", os.path.expanduser("~/.arcen")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "arcen",
        client_title: str = "Arcen Agent",
