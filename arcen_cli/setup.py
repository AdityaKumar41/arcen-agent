...
_DOCS_BASE = "https://arcen-cli.arcenpay.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://arcen-cli.arcenpay.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://arcen-cli.arcenpay.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://arcen-cli.arcenpay.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
