"""
Skills configuration for Arcen Agent.
`arcen skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.arcen/config.yaml under:
...
from arcen_cli.config import cfg_get, load_config, save_config
from arcen_cli.colors import Colors, color
from arcen_cli.platforms import PLATFORMS as _PLATFORMS
