...
def run_uninstall(args):
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  iex (irm https://arcen-agent.arcenpay.com/install.ps1)", Colors.DIM))
        else:
            print(color("  curl -fsSL https://arcen-agent.arcenpay.com/install.sh | bash", Colors.DIM))
        print()
