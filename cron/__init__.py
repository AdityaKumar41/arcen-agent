"""
Cron job scheduling system for Arcen Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    arcen gateway install    # Install as a user service
    sudo arcen gateway install --system  # Linux servers: boot-time system service
    arcen gateway            # Or run in foreground
