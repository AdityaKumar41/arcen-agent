...
Config: ~/.arcen/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.arcen/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_arcen_home()`` helper (ARCEN_HOME-aware and
...
RULES_FILE = get_arcen_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_arcen_home() / "feishu_comment_pairing.json"
