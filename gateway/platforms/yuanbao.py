...
try:
    ...
    _ARCEN_VERSION = "0.0.0"

_APP_VERSION = _ARCEN_VERSION
_BOT_VERSION = _ARCEN_VERSION
_YUANBAO_INSTANCE_ID = str(ARCEN_INSTANCE_ID)  # single source: yuanbao_proto.ARCEN_INSTANCE_ID
