#!/usr/bin/env python3
"""
SWE Runner with Arcen Trajectory Format

A runner that uses Arcen-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Arcen-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Arcen-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Arcen format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Arcen-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Arcen-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Arcen Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Arcen-Agent's built-in execution environments
    and outputs trajectories in Arcen-Agent format.
    """
    ...
    def _convert_to_arcen_format(
        ...
        """
        Convert internal message format to Arcen trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Arcen trajectory format
        trajectory = self._convert_to_arcen_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Arcen trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Arcen Trajectory Format")
    print("=" * 60)
