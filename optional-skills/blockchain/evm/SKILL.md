...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Arcen Agent
license: MIT
...
Helper script path: `~/.arcen/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.arcen/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.arcen/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.arcen/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
