...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Arcen Agent
license: MIT
...
The script reads `~/.arcen/.env` for two optional defaults:
...
Helper script: `~/.arcen/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.arcen/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.arcen/.env`.
...
```bash
python3 ~/.arcen/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.arcen/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
