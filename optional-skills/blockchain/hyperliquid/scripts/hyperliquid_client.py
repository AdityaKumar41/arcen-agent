#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Arcen Agent
-------------------------------------
...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or ~/.arcen/.env."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Arcen Agent")
