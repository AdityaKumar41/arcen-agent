...
```python
import sys
sys.path.insert(0, "/home/teknium/.arcen/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.arcen/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Arcen installs package this)
