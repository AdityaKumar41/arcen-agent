...
version: 0.1.0
author: Mibay (Mibayy), Arcen Agent
license: MIT
...
```
SCRIPT=~/.arcen/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.arcen/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
