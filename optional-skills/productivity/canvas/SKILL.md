...
4. Name the token (e.g., "Arcen Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.arcen/.env`:
...
```bash
CANVAS="python $ARCEN_HOME/skills/productivity/canvas/scripts/canvas_api.py"
