...
Data file: $ARCEN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ARCEN_HOME = Path(os.environ.get("ARCEN_HOME", Path.home() / ".arcen"))
DATA_DIR = _ARCEN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
