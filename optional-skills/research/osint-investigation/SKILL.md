...
author: Arcen Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  arcen:
...
# $ARCEN_OSINT_CACHE/icij/ (default: ~/.cache/arcen-osint/icij/).
...
# Set ARCEN_OSINT_UA=your-app/1.0 (your@email) to identify yourself
