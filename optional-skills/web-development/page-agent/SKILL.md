...
- User wants **Arcen itself to drive a browser** → use Arcen' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
