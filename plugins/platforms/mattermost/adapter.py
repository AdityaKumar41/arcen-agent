...
required — uses aiohttp which is already a Arcen dependency.
...
def interactive_setup() -> None:
    ...
    ``arcen_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Arcen delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # arcen_cli/setup.py::_setup_mattermost function.
