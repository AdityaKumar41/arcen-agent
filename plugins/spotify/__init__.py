...
``_check_spotify_available()`` — when the user has not run ``arcen auth
spotify``, the tools remain registered (so they appear in ``arcen
...
The Spotify auth flow (``arcen auth spotify``), CLI plumbing, and docs
