...
def _profile_user_agent() -> str:
    """Return a ``arcen-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from arcen_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"arcen-cli/{_ver}"
    except Exception:
        return "arcen-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # arcen-cli UA so the catalog endpoint is reachable.
