#!/usr/bin/env python3
"""Build the Arcen Model Catalog — a centralized JSON manifest of curated models.
...
Arcen CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Arcen release.
...
``https://arcen-cli.arcenpay.com/docs/api/model-catalog.json``
"""
...
# Ensure ARCEN_HOME is set for imports that touch it at module level.
os.environ.setdefault("ARCEN_HOME", os.path.join(os.path.expanduser("~"), ".arcen"))

from arcen_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://arcen-cli.arcenpay.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
