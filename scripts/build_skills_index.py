#!/usr/bin/env python3
"""Build the Arcen Skills Index — a centralized JSON catalog of all skills.
...
`arcen skills search/install` can use it without hitting the GitHub API.
...
# Ensure ARCEN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Arcen Skills Index...", flush=True)
