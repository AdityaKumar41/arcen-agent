...
DEFAULT_DATASETS = [
    ...
    "NousResearch/arcen-agent-megascience-sft1",
    "NousResearch/Arcen-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Arcen-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-arcen-agent"
]
