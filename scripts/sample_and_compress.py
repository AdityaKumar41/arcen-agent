...
DEFAULT_DATASETS = [
    "ArcenPay/swe-terminus-agent-glm-kimi-minimax",
    "arcenpay/arcen-agent-megascience-sft1",
    "ArcenPay/Arcen-Agent-Thinking-GLM-4.7-SFT2",
    "ArcenPay/Arcen-Agent-Thinking-GLM-4.7-SFT1",
    "ArcenPay/terminal-tasks-glm-arcen-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ArcenPay/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ArcenPay/{output_name} {final_output}")
