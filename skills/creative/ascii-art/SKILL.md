...
```bash
python3 -m pyfiglet "ARCEN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ARCEN&font=Slant" | boxes -d stone
```
