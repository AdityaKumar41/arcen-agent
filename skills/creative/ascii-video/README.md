...
Built for [Arcen Agent](https://github.com/NousResearch/arcen-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/arcen-agent/skills/creative/ascii-video`](https://github.com/NousResearch/arcen-agent/tree/main/skills/creative/ascii-video) via PR.
