...
Built for [Arcen Agent](https://github.com/AdityaKumar41/arcen-agent). Usable in any coding agent. Canonical source lives here; synced to [`AdityaKumar41/arcen-agent/skills/creative/ascii-video`](https://github.com/AdityaKumar41/arcen-agent/tree/main/skills/creative/ascii-video) via PR.
