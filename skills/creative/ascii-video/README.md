...
Built for [Arcen Agent](https://github.com/arcenpay/arcen-agent). Usable in any coding agent. Canonical source lives here; synced to [`arcenpay/arcen-agent/skills/creative/ascii-video`](https://github.com/arcenpay/arcen-agent/tree/main/skills/creative/ascii-video) via PR.
