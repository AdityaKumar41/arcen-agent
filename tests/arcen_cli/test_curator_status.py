"""Tests for `arcen curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import arcen_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ARCEN_HOME with real agent-created skills on disk."""
    home = tmp_path / ".arcen"
    skills = home / "skills"
    ...
    from arcen_cli import curator as curator_cli
