"""Tests for the specifier module + `arcen kanban specify` CLI surface.
...
from arcen_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `arcen kanban …` argparse surface directly."""
