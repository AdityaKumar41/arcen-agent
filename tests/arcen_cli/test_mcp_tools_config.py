"""Tests for MCP tools interactive configuration in arcen_cli.tools_config."""

from unittest.mock import patch

from arcen_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "arcen_cli.curses_ui.curses_checklist"
_SAVE = "arcen_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `arcen mcp configure`, and this UI all write the same
