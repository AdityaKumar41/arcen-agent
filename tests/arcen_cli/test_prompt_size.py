"""Tests for the ``arcen prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from arcen_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(arcen_home, memory_text="", user_text=""):
    mem_dir = arcen_home / "memories"
...
def _seed_skill(arcen_home, name, description):
    skill_dir = arcen_home / "skills" / "demo" / name
