"""Tests for the interactive session browser (`arcen sessions browse`).
...
from arcen_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """arcen sessions browse should be parseable."""
