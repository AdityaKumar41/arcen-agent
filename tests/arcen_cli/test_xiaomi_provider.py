...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from arcen_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ARCEN_OVERLAYS
        overlay = ARCEN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify arcen doctor recognizes Xiaomi env vars."""
