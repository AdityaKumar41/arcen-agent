...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("arcen_cli.config.get_config_path", return_value=config_path), \
             patch("arcen_cli.config.ensure_arcen_home"):
    ...
    def test_ensure_arcen_home_sets_0700(self):
        home = Path(self.tmpdir) / ".arcen"
        with patch("arcen_cli.config.get_arcen_home", return_value=home):
