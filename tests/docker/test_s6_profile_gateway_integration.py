...
The unit tests in tests/arcen_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned arcen-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/arcen")
from arcen_cli.service_manager import S6ServiceManager
