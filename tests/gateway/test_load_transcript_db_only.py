...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.arcen/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at arcen_state import time, before pytest's ARCEN_HOME monkeypatch
    fires — the autouse fixture's ARCEN_HOME override doesn't help here.)
    """
    import arcen_state
