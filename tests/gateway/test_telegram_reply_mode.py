...
class TestTelegramYamlConfigLoading:
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        arcen_home.mkdir()
        (arcen_home / "config.yaml").write_text(content, encoding="utf-8")
        return arcen_home
    ...
    def test_top_level_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        arcen_home = self._write_config(tmp_path, "telegram:\n  reply_to_mode: off\n")
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/AdityaKumar41/arcen-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending vian Arcen-created DM topic
