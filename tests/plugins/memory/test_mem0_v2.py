...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "arcen"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "arcen"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_arcen_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "arcen-user"

    def test_default_agent_id_arcen(self, monkeypatch, tmp_path):
        monkeypatch.setenv("MEM0_API_KEY", "test-key")
        ...
        assert provider._agent_id == "arcen"
