...
def worker_loop(worker_id: int, arcen_home: str, result_file: str) -> None:
...
def reclaimer_loop(arcen_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="arcen_mixed_stress_")
    print(f"ARCEN_HOME = {home}")
