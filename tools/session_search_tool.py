...
the get_anchored_view / get_messages_around primitives in arcen_state.
...
# Third-party integrations tag their sessions with ARCEN_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from arcen_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Arcen profile's database "
