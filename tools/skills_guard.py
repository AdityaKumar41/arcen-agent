...
Trust levels:
  - builtin:   Ships with Arcen. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.arcen/\.env|\~/\.arcen/\.env',
     "arcen_env_access", "critical", "exfiltration",
     "directly references Arcen secrets file"),
    ...
    (r'\.arcen/config\.yaml|\.arcen/SOUL\.md',
     "arcen_config_mod", "critical", "persistence",
     "references Arcen configuration files directly"),
...
# scan. `.skillignore` is the Arcen-native name; `.clawhubignore` is honored
