 ...
 *
 * Symptom: in `arcen --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@arcen/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using arcen --tui and as i type multiline my caret at the end will often ' +
