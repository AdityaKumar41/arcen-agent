...
import type { ScrollBoxHandle } from '@arcen/ink'
import { evictInkCaches } from '@arcen/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ARCEN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
