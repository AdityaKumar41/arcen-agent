...
export default function LanyardWithControls({
  ...
  const shareMessage = appliedName
    ? `Check out my personalized Arcen Agent developer badge! The self-improving AI agent that grows with you.`
    : `Check out Arcen Agent! Create your personalized developer badge.`;
